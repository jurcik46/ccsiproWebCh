...
namespace WebChromiumCcsipro.UI.VirtualKeyboard
{
    ...
    internal class TouchKeyboardEventManager : IDisposable
    {
        ...
        private InputPaneRcw.IInputPaneInterop inputPaneInterop = null;

        private InputPaneRcw.IInputPane2 inputPanel = null;
        ...
        internal TouchKeyboardEventManager(IntPtr handle)
        {
            ...
            inputPaneInterop = WindowsRuntimeMarshal.GetActivationFactory(inputPaneType) as InputPaneRcw.IInputPaneInterop;
            ...
            if (touchKeyboardSupported)
            {
                ...
                inputPanel = inputPaneInterop.GetForWindow(handle, typeof(InputPaneRcw.IInputPane2).GUID);
            }
        }
        ...
        internal InputPaneRcw.IInputPane2 GetInputPane()
        {
            if (!touchKeyboardSupported)
            {
